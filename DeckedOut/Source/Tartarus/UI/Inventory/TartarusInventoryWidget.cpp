...
void UTartarusInventoryWidget::NativeOnDeactivated()
{
...
#pragma region CharacterPreview
void UTartarusInventoryWidget::CreateSceneCapture()
{
	// Get the player
	const ATartarusPlayerController* const PlayerController = GetOwningPlayer<ATartarusPlayerController>();
	if (!IsValid(PlayerController))
...
void UTartarusInventoryWidget::AssociateSceneCapture()
{
	// Get the player
	const ATartarusPlayerController* const PlayerController = GetOwningPlayer<ATartarusPlayerController>();
	if (!IsValid(PlayerController))
...
void UTartarusInventoryWidget::DissociateSceneCapture()
{
	// Get the player
	const ATartarusPlayerController* const PlayerController = GetOwningPlayer<ATartarusPlayerController>();
	if (!IsValid(PlayerController))
